...
@Component({
  selector: 'app-status-bar-scroll',
  templateUrl: './status-bar-scroll.page.html',
  styleUrls: ['./status-bar-scroll.page.scss'],
})
export class StatusBarScrollPage implements OnInit {
  ...
  moveToFirstPage() {
    this.navController.navigateBack('/ion-slides');
  }
